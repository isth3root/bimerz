...
export function FAQSection() {
  ...
  const faqs = [
    ...
    {
      id: "faq-10",
      question: "اگر موقع حادثه راننده کسی غیر از مالک خودرو باشد، بیمه خسارت را پرداخت می‌کند؟",
      answer: "بله، در بیمه شخص ثالث مهم نیست چه کسی راننده باشد؛ خسارت به زیان‌دیدگان پرداخت می‌شود."
    },
    {
      id: "faq-11",
      question: "آیا بیمه آتش‌سوزی فقط مخصوص خانه است؟",
      answer: "خیر، بیمه آتش‌سوزی علاوه بر خانه برای مغازه، دفتر کار یا انبار هم صادر می‌شود"
    }
  ];
